...
### Texture Replacement  
Texture replacement is the easiest to mod. An example can be found in [PAK Example](https://quantumnuke75.github.io/Unofficial-Modding-Guide/importantinformation.html). If you are doing more than recoloring, you will also need to edit the normal and ORM maps.
